...
import card1 from "../../assets/kettivalley.jpeg"
import card2 from "../../assets/madrasregimentalmuseum.jpeg"
import card3 from "../../assets/simspark.jpeg"
import card4 from "../../assets/dolphinoseview.jpeg"
import card5 from "../../assets/teagarden.jpeg"

const CoonorPackagesDetailedSection = () => {
    return(
        <div>
            <div className="packagesdetailed-section-container">
                <h1 className="packagesdetailed-heading">Star Your Journey From Exploring<br/> Coonor City </h1>
            ...
            <div className="activities-container">
                ...
                <div className="activities-grid">
                    ...
                    <div  className="activity-card">
                        ...
                        <div className="location">Coonor</div>
                        <h3 className="activity-title">Ketti Valley 

                        </h3>
                        <p className="activity-description"> Take in breathtaking views of one of the largest valleys in India.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Coonor</div>
                        <h3 className="activity-title">Madras Regimental Museum 
                        </h3>
                        <p className="activity-description">Discover India’s military history in a proud heritage museum.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Coonor</div>
                        <h3 className="activity-title">Sims Park

                        </h3>
                        <p className="activity-description">A beautiful botanical park with rare plants and a peaceful vibe.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Coonor</div>
                        <h3 className="activity-title">Dolphinose View Point
                        </h3>
                        <p className="activity-description">Gaze out at Catherine Falls and green slopes from a cliff that looks like a dolphin’s nose.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Coonor</div>
                        <h3 className="activity-title">Tea Garden 

                        </h3>
                        <p className="activity-description">Walk among rolling tea plantations and inhale the aroma of fresh leaves.
...
export default CoonorPackagesDetailedSection;