...
import card2 from "../../assets/Masinagudi.jpeg";
import card3 from "../../assets/BandipurNationalPark.jpeg";
import card4 from "../../assets/MoyarRiver.jpeg";
import card5 from "../../assets/TheppakaduElephantCamp.jpeg";
import "./index.css";

const MadhumalaiPackagesDetailedSection = () => {
    return(
        <div>
            <div className="packagesdetailed-section-container">
                <h1 className="packagesdetailed-heading">Star Your Journey From Exploring<br/> Madhumalai City </h1>
            ...
            <div className="activities-container">
                ...
                <div className="activities-grid">
                    ...
                    <div  className="activity-card">
                        ...
                        <div className="location">Madhumalai</div>
                        <h3 className="activity-title">Masinagudi</h3>
                        <p className="activity-description">The Gateway to Wildlife: Adjacent to Mudumalai.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Madhumalai</div>
                        <h3 className="activity-title"> Bandipur National Park
                        </h3>
                        <p className="activity-description">Cross over to Karnataka to explore Bandipur National Park.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <p className="activity-description">Enjoy a peaceful boat ride surrounded by Ooty’s calm lake waters and scenic hills.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Madhumalai</div>
                        <h3 className="activity-title">Moyar River
                        </h3>
                        <p className="activity-description">Flowing through the heart of Mudumalai</p>
                        </div>
                    </div>
...
export default MadhumalaiPackagesDetailedSection;