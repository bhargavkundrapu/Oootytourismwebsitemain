...
import card1 from "../../assets/govtmuseim.jpeg"
...
const GovtmuseumPackagesDetailedSection = () => {
    return(
        <div>
            ...
            <div className="activities-container">
                ...
                <div className="activities-grid">
                    ...
                    <div  className="activity-card">
                        ...
                        <h3 className="activity-title">Government Museum
                        </h3>
                        <p className="activity-description">The Government Museum in Ooty, situated on the Ooty-Mysore Road.</p>
                        </div>
                    </div>
...
export default GovtmuseumPackagesDetailedSection;