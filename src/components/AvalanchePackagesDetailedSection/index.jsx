...
import card1 from "../../assets/AvalancheLake.jpeg"
import card2 from "../../assets/EmeraldLake.jpeg"
import card3 from "../../assets/ParsonsValleyReservoir.jpeg"
import card4 from "../../assets/MukurthiNationalPark.jpeg"
import card5 from "../../assets/CairnHill.jpeg"

const AvalanchePackagesDetailedSection = () => {
    return(
        <div>
            <div className="packagesdetailed-section-container">
                <h1 className="packagesdetailed-heading">Star Your Journey From Exploring<br/> Avalanche City </h1>
            ...
            <div className="activities-container">
                ...
                <div className="activities-grid">
                    ...
                    <div  className="activity-card">
                        ...
                        <div className="location">Avalanche</div>
                        <h3 className="activity-title">Avalanche Lake
                        </h3>
                           <p className="activity-description">A beautiful lake surrounded by nature, offering a scenic view and a place for boating. </p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Avalanche</div>
                        <h3 className="activity-title">Emerald Lake</h3>
                        <p className="activity-description">Another notable lake near Avalanche, known for its scenic beauty and calm atmosphere. 
                        </p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        ...
                        <div className="card-content">
                        <div className="location">Avalanche</div>
                        <h3 className="activity-title">Parsons Valley Reservoir
                        </h3>
                        <p className="activity-description">A reservoir near Avalanche, known for its serene environment and scenic views.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Avalanche</div>
                        <h3 className="activity-title">Mukurthi National Park</h3>
                        <p className="activity-description">A wildlife sanctuary near Avalanche, spots various flora. 
                        </p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        ...
                        <div className="card-content">
                        <div className="location">Avalanche</div>
                        <h3 className="activity-title">Cairn Hill
                        </h3>
                        <p className="activity-description">A hilltop offering panoramic views of the surrounding area. 
                        </p>
                        </div>
                    </div>
...
export default AvalanchePackagesDetailedSection;