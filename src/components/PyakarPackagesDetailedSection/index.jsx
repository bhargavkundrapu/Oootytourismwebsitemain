...
import card1 from "../../assets/pykarafall.jpeg"
import card2 from "../../assets/pykaraboat.jpeg"
import card3 from "../../assets/shootings.jpeg"
import card4 from "../../assets/mile.jpeg"
import card5 from "../../assets/pineforest.jpeg"

const PyakarPackagesDetailedSection = () => {
    return(
        <div>
            <div className="packagesdetailed-section-container">
                <h1 className="packagesdetailed-heading">Star Your Journey From Exploring<br/> Pyakar City </h1>
            ...
            <div className="activities-container">
                ...
                <div className="activities-grid">
                    ...
                    <div  className="activity-card">
                        ...
                        <div className="location">Pyakar</div>
                        <h3 className="activity-title">Pykara Falls 
                        </h3>
                        <p className="activity-description"> Witness the majestic cascade of water through thick forests.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Pyakar</div>
                        <h3 className="activity-title">Pykara Boat Hous</h3>
                        <p className="activity-description"> Enjoy boating in a calm lake amidst pine-covered hills.
                    ...
                    <div  className="activity-card">
                        ...
                        <div className="card-content">
                        <div className="location">Pyakar</div>
                        <h3 className="activity-title">Shooting Spot

                        </h3>
                        <p className="activity-description"> Explore scenic landscapes where movies come to life.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Pyakar</div>
                        <h3 className="activity-title">6th Mile
                        </h3>
                        <p className="activity-description">A peaceful meadow known for movie shoots and nature views.</p>
                        </div>
                    </div>
                    <div  className="activity-card">
                        <div className="activity-image">
                        ...
                        <div className="card-content">
                        <div className="location">Pyakar</div>
                        <h3 className="activity-title">Pine Forest 

                        </h3>
                        <p className="activity-description">Walk through dense, dreamy pine trees straight out of a fairy tale.</p>
                        </div>
                    </div>
...
export default PyakarPackagesDetailedSection;